...
const Post = (props) => (
    ...
    <td>
        {props.post.Image &&(
            <img 
            src={ `data:image/jpeg;base64,${props.post.Image}`}//convert base 64 to string to image
            alt="Post Image"
            style={{maxWidth: '100px', maxHeight:'100px', objectfit:'cover' }} //ensure that the image fits in the sizelimit 
        />
        )}
        </td>
<td>
...
export default function PostList() {
    ...
    //This method detches the posts from the database
    useEffect(()=>{
